import sys
sys.path.append('C:\\Users\\itsas\\Desktop\\ode_solver\\model')

from first_ode import Network  # This should now work
...
from first_ode import Network  # First-order model from first-ode.py
from second_ode import Network2  # Second-order model from second-ode.py
